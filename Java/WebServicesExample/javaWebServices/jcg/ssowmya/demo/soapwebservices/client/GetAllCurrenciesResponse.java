 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://soapwebservices.demo.ssowmya.jcg/}currency" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAllCurrenciesResponse {
    ...
    protected List<Currency> _return;
     ...
     * 
     */
    public List<Currency> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Currency>();
        }
        return this._return;
    }
